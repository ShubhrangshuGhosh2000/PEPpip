...
def extract_prot_seq_2D_manual_feat_for_dock(fastas,folderName,featureSets,processPSSM=True,deviceType='cpu'    ):
    t =time.time()

    if 'SkipGramAA7' in featureSets:
        SkipGram(fastas,folderName+'/'+'SkipGramAA7H5.encode',hiddenSize=5,preTrained=True,deviceType='cpu',fullGPU=False)
        print('SkipGramAA7',time.time()-t)
