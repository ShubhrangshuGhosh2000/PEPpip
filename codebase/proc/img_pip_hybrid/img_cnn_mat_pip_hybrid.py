...
if __name__ == '__main__':
    ...
    mat_p2ip_DS_data_path = os.path.join(root_path, 'dataset/proc_data_DS/mat_res_origMan_auxTlOtherMan_human')
    mat_p2ip_hybrid_data_path = os.path.join(root_path, 'dataset/proc_data_tl_feat_to_img/img_mat_pip_hybrid/img_cnn_mat_pip_hybrid/dscript_other_spec_ResNet_manTlStruct_r400n18D')
