...
def create_hyb_predicted_contact_map(root_path='./', cnn_model_path='./', trx_model_path='./', docking_version='4_0'
...
def calculate_emd_betwn_gt_and_pred_hyb_contact_maps(root_path='./', docking_version='4_0'
...
def create_consolidated_emd_res_csv(emd_res_df_lst=None, root_path='./', docking_version='4_0'
                                                 , consider_full=False):
