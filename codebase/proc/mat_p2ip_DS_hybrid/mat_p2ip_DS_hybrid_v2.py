...
def create_hybrid_score(spec_type = 'ecoli', orig_dscript_data_path = './', mat_p2ip_DS_data_path = './', mat_p2ip_hybrid_data_path = './'):
    ...
    mat_p2ip_DS_spec_res_df = pd.read_csv(os.path.join(mat_p2ip_DS_data_path, 'mat_res_origMan_auxTlOtherMan_' + spec_type + '_model_full', 'pred_' + spec_type + '_DS.tsv')
...
if __name__ == '__main__':
    ...
    orig_dscript_data_path = os.path.join('/scratch/pralaycs/Shubh_Working_Remote/PPI_Wkspc/PPI_Code/mat_p2ip_prj_working/dscript_full/cross_spec_pred_result_seq_len400')
    mat_p2ip_DS_data_path = os.path.join(root_path, '/scratch/pralaycs/Shubh_Working_Remote/PPI_Wkspc/PPI_Code/mat_p2ip_prj_working/dataset/proc_data_DS')
    mat_p2ip_hybrid_data_path = os.path.join(root_path, 'dataset/proc_data_DS/mat_p2ip_DS_hybrid_seq_len400')
