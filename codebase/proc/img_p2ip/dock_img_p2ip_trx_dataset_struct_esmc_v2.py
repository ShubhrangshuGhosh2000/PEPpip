...
class DockImgP2ipCustomDataset(Dataset):
    def __init__(self, root_path='./', spec_type='human', docking_version='5_5'
    ...
    def __getitem__(self, idx):
        ...
        prot1_tl_2dArr_file_nm_loc = os.path.join(self.root_path, 'dataset/preproc_data_docking_BM_' + str(self.docking_version), 'dock_tl_2d_feat_dict_dump_img', f"prot_id_{prot1_id}.pkl")
        prot1_tl_2dArr = joblib.load(prot1_tl_2dArr_file_nm_loc)
        prot2_tl_2dArr_file_nm_loc = os.path.join(self.root_path, 'dataset/preproc_data_docking_BM_' + str(self.docking_version), 'dock_tl_2d_feat_dict_dump_img', f"prot_id_{prot2_id}.pkl")
        ...
        prot1_esmc_2dArr_file_nm_loc = os.path.join(self.root_path, 'dataset/preproc_data_docking_BM_' + str(self.docking_version), 'dock_tl_esmc_2d_feat_dict_dump_img', f"prot_id_{prot1_id}.pkl")
        prot1_esmc_2dArr = joblib.load(prot1_esmc_2dArr_file_nm_loc)
        prot1_esmc_2dArr = prot1_esmc_2dArr[1:prot1_esmc_2dArr.shape[0]-1, :]  
        prot2_esmc_2dArr_file_nm_loc = os.path.join(self.root_path, 'dataset/preproc_data_docking_BM_' + str(self.docking_version), 'dock_tl_esmc_2d_feat_dict_dump_img', f"prot_id_{prot2_id}.pkl")
