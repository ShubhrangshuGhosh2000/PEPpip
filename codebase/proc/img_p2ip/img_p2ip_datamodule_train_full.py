...
class ImgP2ipCustomDataModule(L.LightningDataModule):
    ...
    def setup(self, stage=None):
        ...
        mean_std_train_df = pd.read_csv(os.path.join(self.root_path, 'dataset/preproc_data_tl_feat_to_img/train_test_list_dump', 'mean_std_train_full_manTl.csv'))
        ...
        if stage == "fit" or stage is None:  # for training
            ...
            # TRAINING IS ON FULL TRAINING DATA SET (i.e. Train + Validation) AFTER HYPER-PARAM TUNING
