...
from proc.img_p2ip.img_p2ip_cnn.img_p2ip_cnn_clf_train_full import ImgP2ipCnn
...
if __name__ == '__main__':
    ...
    model_path = os.path.join(root_path, 'dataset/proc_data_tl_feat_to_img/img_p2ip_cnn/train/ResNet_manTl_r400n18D_fullTrain')
