...
from proc.img_p2ip.img_p2ip_cnn.img_p2ip_cnn_clf_train_full_struct import ImgP2ipCnn
...
if __name__ == '__main__':
    ...
    model_path = os.path.join(root_path, 'dataset/proc_data_tl_feat_to_img/img_p2ip_cnn/train/ResNet_manTlStruct_r400n18D_fullTrain')
    partial_model_name = 'ImgP2ipCnn'

    spec_type_lst = ['ecoli', 'fly', 'mouse', 'worm', 'yeast']  # human, ecoli, fly, mouse, worm, yeast
    # spec_type_lst = ['ecoli']  # human, ecoli, fly, mouse, worm, yeast
