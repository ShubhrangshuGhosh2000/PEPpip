...
if __name__ == '__main__':
    ...
    # prv_ckpt_path = None
    prv_ckpt_path = os.path.join(root_path, 'dataset/proc_data_tl_feat_to_img/img_p2ip_cnn/train/ResNet_expt_r800n22ND')
    start(root_path=root_path, model_name='ResNet', save_name='ResNet_expt_r800n22ND', prv_ckpt_path=prv_ckpt_path)
