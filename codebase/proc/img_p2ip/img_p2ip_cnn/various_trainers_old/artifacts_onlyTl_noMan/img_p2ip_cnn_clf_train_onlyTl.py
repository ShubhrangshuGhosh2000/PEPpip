...
from proc.img_p2ip.img_p2ip_datamodule_onlyTl import ImgP2ipCustomDataModule
...
if __name__ == '__main__':
    ...
    start(root_path=root_path, model_name='ResNet', save_name='ResNet_expt_r400n18D', prv_ckpt_path=prv_ckpt_path)
