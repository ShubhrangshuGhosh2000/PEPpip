...
def postproc_attr_result(root_path='./', model_path='./', spec_type='ecoli', con_attrForPositiveRes_dict_lst=None):
    ...
    for itr in range(start_itr, con_attrForPositiveRes_dict_lst_len, 1):
        ...
        postproc_res_dict_file_nm_with_loc = os.path.join(xai_result_dir, 
                                                          spec_type + '_attr_postproc', 
        ...
        # # add postproc_res_dict to postproc_attrForPositiveRes_dict_lst
        # postproc_attrForPositiveRes_dict_lst.append(postproc_res_dict)
    # end of for loop: for itr in range(con_attrForPositiveRes_dict_lst_len):
