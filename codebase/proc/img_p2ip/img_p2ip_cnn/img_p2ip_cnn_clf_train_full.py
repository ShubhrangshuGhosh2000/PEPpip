...
from proc.img_p2ip.img_p2ip_datamodule_train_full import ImgP2ipCustomDataModule
...
def start(root_path='./', model_name = 'ResNet', save_name=None, prv_ckpt_path=None):
    ...
    if(model_name == 'ResNet'):
        ...
        config["num_workers"] = os.cpu_count() - 2  # for the DataModule creation (in single node case)
...
if __name__ == '__main__':
    ...
    prv_ckpt_path = None
    prv_ckpt_path = os.path.join(root_path, 'dataset/proc_data_tl_feat_to_img/img_p2ip_cnn/train/ResNet_manTl_r400n18D_fullTrain')
    start(root_path=root_path, model_name='ResNet', save_name='ResNet_manTl_r400n18D_fullTrain', prv_ckpt_path=prv_ckpt_path)
