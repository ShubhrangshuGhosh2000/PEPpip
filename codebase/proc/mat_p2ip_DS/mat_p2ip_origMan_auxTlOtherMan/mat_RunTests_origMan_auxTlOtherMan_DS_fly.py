...
def execute(spec_type = 'human'): 
    ...
    hyp['maxProteinLength'] = 400  # default: 50
    # # for normalization
    ...
    # human_full_model_loc = os.path.join(root_path, 'dataset/proc_data_DS/mat_res_origMan_auxTlOtherMan_human/DS_human_len400.out')
